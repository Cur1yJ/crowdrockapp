...
class Ion_auth_model extends CI_Model
{
	 ...
	 * @author Mathew
	 **/
	public function login($identity, $password, $remember=FALSE, $thirdparty_authentication=FALSE)
	{
		$this->trigger_events('pre_login');
        $set_session = FALSE;

		if (empty($identity) || (empty($password) && !$thirdparty_authentication))
		{
